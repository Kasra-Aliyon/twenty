...
export const registerApolloEnrichmentTools = (
  ...
  server.registerTool(
    'twenty_enrich_people_with_apollo',
    {
      ...
      description:
        'Enriches empty person data and requests Apollo email and phone waterfall enrichment for up to 100 people. Credit usage depends on the configured waterfall providers, and results may be asynchronous. Requires TWENTY_USER_TOKEN and explicit confirmation of all record IDs.',
  ...
  server.registerTool(
    'twenty_enrich_people_phones_with_apollo',
    {
      ...
      description:
        'Requests Apollo phone waterfall enrichment for up to 100 people. Credit usage depends on the configured waterfall providers, and results may arrive asynchronously over several minutes. Requires TWENTY_USER_TOKEN and explicit confirmation of all record IDs.',
      inputSchema: apolloEnrichmentInputSchema,
      outputSchema: TOOL_OUTPUT_SCHEMA,
      annotations: {
        readOnlyHint: false,
