...
>): Record<AllStandardObjectFieldName<'person'>, FlatFieldMetadata> => ({
  ...
  linkedinConnectionState: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'linkedinConnectionState',
      type: FieldMetadataType.SELECT,
      label: i18nLabel(msg`LinkedIn connection state`),
      description: i18nLabel(msg`Latest connection state observed on LinkedIn`),
      icon: 'IconBrandLinkedin',
      isNullable: false,
      defaultValue: `'${LINKEDIN_CONNECTION_STATES.UNKNOWN}'`,
      options: [
        {
          id: 'e6b93cba-cd93-4705-9c42-cfabe6c8765e',
        ...
        {
          id: 'dc24acb5-ef20-487d-a10c-4939e0f0b5dc',
        ...
        {
          id: 'ed7e319d-0d7f-4fb9-add6-22780767dac2',
        ...
        {
          id: 'f1ba508e-65e7-48ba-8235-bd4771aaf120',
        ...
        {
          id: '0a7c76ec-3749-4619-a2ff-c522eaa2a35a',
  ...
  address: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Address of the person`),
      icon: 'IconMap',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  emailOptOut: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(msg`Email opt-out`),
      description: i18nLabel(msg`Prevent automated outreach emails`),
      icon: 'IconMailOff',
      isNullable: false,
      defaultValue: false,
    },
  ...
  recordListMemberships: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(msg`Static lists`),
      description: i18nLabel(msg`Static lists containing the person`),
  ...
  sequenceEnrollments: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Outreach sequences containing the person`),
      icon: 'IconSend',
      isUIEditable: false,
      isNullable: true,
  ...
  linkedinActions: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'linkedinActions',
      label: i18nLabel(msg`LinkedIn actions`),
      description: i18nLabel(msg`Automated LinkedIn actions for this person`),
      icon: 'IconBrandLinkedin',
      isUIEditable: false,
      isNullable: true,
      targetObjectName: 'linkedinAction',
      targetFieldName: 'person',
      settings: { relationType: RelationType.ONE_TO_MANY },
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  linkedinConnectedAt: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'linkedinConnectedAt',
      type: FieldMetadataType.DATE_TIME,
      label: i18nLabel(msg`LinkedIn connected at`),
      description: i18nLabel(
        msg`Most recent date this person was connected on LinkedIn`,
      ),
      icon: 'IconCalendarClock',
      isNullable: true,
      isUIEditable: false,
