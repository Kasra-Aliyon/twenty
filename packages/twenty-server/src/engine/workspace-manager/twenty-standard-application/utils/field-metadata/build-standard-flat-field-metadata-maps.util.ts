...
import { buildLinkedinActionStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-linkedin-action-standard-flat-field-metadata.util';
import { buildLinkedinConnectionStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-linkedin-connection-standard-flat-field-metadata.util';
import { buildLinkedinInvitationStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-linkedin-invitation-standard-flat-field-metadata.util';
import { buildLinkedinMessageThreadStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-linkedin-message-thread-standard-flat-field-metadata.util';
import { buildLinkedinMessageStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-linkedin-message-standard-flat-field-metadata.util';
import { buildLinkedinThreadParticipantStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-linkedin-thread-participant-standard-flat-field-metadata.util';
...
import { buildMessageDraftStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-message-draft-standard-flat-field-metadata.util';
...
const STANDARD_FLAT_FIELD_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  linkedinAction: buildLinkedinActionStandardFlatFieldMetadatas,
  linkedinConnection: buildLinkedinConnectionStandardFlatFieldMetadatas,
  linkedinInvitation: buildLinkedinInvitationStandardFlatFieldMetadatas,
  linkedinMessage: buildLinkedinMessageStandardFlatFieldMetadatas,
  linkedinMessageThread: buildLinkedinMessageThreadStandardFlatFieldMetadatas,
  linkedinThreadParticipant:
    buildLinkedinThreadParticipantStandardFlatFieldMetadatas,
  messageCampaign: buildMessageCampaignStandardFlatFieldMetadatas,
  messageDraft: buildMessageDraftStandardFlatFieldMetadatas,
