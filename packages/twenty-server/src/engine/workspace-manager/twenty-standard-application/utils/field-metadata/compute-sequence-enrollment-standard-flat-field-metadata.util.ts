  ...
  waitingOn: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      options: [
        ...
        {
          id: 'db87efab-54cf-47ce-8815-1ed7b70112a4',
          value: SEQUENCE_WAITING_ON.APOLLO_ENRICHMENT_CLAIMED,
          label: i18nLabel(msg`Apollo enrichment claimed`),
          position: 5,
          color: 'yellow',
        },
        {
          id: '6710ff26-ed56-446e-ae01-a8ac31f299ca',
          value: SEQUENCE_WAITING_ON.APOLLO_ENRICHMENT_JOINED,
          label: i18nLabel(msg`Apollo enrichment joined`),
          position: 6,
          color: 'yellow',
        },
        {
          id: '2916538a-9c9b-45b5-a34f-d868268abed6',
          value: SEQUENCE_WAITING_ON.APOLLO_ENRICHMENT,
          label: i18nLabel(msg`Apollo enrichment`),
          position: 7,
          color: 'green',
        },
      ],
