...
describe('extractFileIdFromUrl', () => {
  ...
  it('should work with query params', () => {
    const url = `http://localhost:2000/file/${FileFolder.FilesField}/${validUuid}?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..qBy0SvkAuaq-KwWIALasRVJwSkN9Llu15LXUnVZMy-Y`;
