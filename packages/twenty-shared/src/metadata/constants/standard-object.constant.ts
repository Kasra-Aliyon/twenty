...
export const STANDARD_OBJECTS = {
  ...
  company: {
    ...
    fields: {
      ...
      recordListMemberships: {
        universalIdentifier: 'de766bdf-707f-409d-9145-4e6c288aba59',
      },
      searchVector: {
  ...
  recordListFolder: {
    universalIdentifier: '614f1f14-4bb9-4e98-b7ab-16396dfdb408',
    fields: {
      id: { universalIdentifier: '7f742d4e-af13-4301-bf6c-4177834676b1' },
      createdAt: {
        universalIdentifier: '64164e69-0b0f-4cd7-b755-1a6ae5330412',
      },
      updatedAt: {
        universalIdentifier: '5e4e34b3-18b3-4d1b-ae91-befe63581b09',
      },
      deletedAt: {
        universalIdentifier: '247caf3b-7f43-478c-884f-fd04beb9fab6',
      },
      createdBy: {
        universalIdentifier: '59f3483e-0bf9-40ab-8bea-b12becab7007',
      },
      updatedBy: {
        universalIdentifier: 'd954f71d-05dd-48aa-b381-7a3c8ec55e9e',
      },
      position: {
        universalIdentifier: 'de63bba0-05d3-4393-aee5-871380b86098',
      },
      searchVector: {
        universalIdentifier: '6cdf1e37-a224-4ada-ab63-b0581ef87bad',
      },
      name: { universalIdentifier: '19c9fe66-d122-4846-b835-da6027a262ac' },
      lists: {
        universalIdentifier: 'e2e07c2f-5770-45b9-bf9b-3a42b392224c',
      },
    },
    indexes: {
      positionIndex: {
        universalIdentifier: 'f650e3ff-fcc2-4ee9-b49c-3b160cd54ba9',
      },
    },
  },
  recordList: {
    universalIdentifier: 'cc7b0bc4-3d46-4158-812d-ff6632e41daa',
    fields: {
      id: { universalIdentifier: '7446b45b-66ed-40ae-89e3-dbd5405fd2a1' },
      createdAt: {
        universalIdentifier: '120e1d3a-7766-41e7-8995-017114ebf867',
      },
      updatedAt: {
        universalIdentifier: '008026f7-8c3e-4335-98ff-209b531cd174',
      },
      deletedAt: {
        universalIdentifier: '8356153f-3c92-4c32-968d-7b33f17ff991',
      },
      createdBy: {
        universalIdentifier: 'a969df77-a7a3-4cce-b40b-7f68ecf99b95',
      },
      updatedBy: {
        universalIdentifier: '9daad302-764c-412e-9228-ee7b938b8e0b',
      },
      position: {
        universalIdentifier: '315aefcc-de45-4b98-8715-116f422715ed',
      },
      searchVector: {
        universalIdentifier: '5842c526-e9bb-4b69-9b1d-79f27a8253b6',
      },
      name: { universalIdentifier: '3b9abc7b-4017-48b6-830a-8e1a7dc33a58' },
      type: { universalIdentifier: 'c66315d8-4662-4835-badb-66e2176b8b9c' },
      folder: {
        universalIdentifier: '41cc9b76-2fbc-44c9-a39d-914ee7de4195',
      },
      members: {
        universalIdentifier: '0f3fa618-e4f6-4f91-88a2-98ae4c54c4f5',
      },
    },
    indexes: {
      folderIdIndex: {
        universalIdentifier: '821c13f3-71a6-42ca-b131-4cc0f54e2cea',
      },
      folderPositionIndex: {
        universalIdentifier: '298c80d0-b696-4213-9d95-8d17fd4a08de',
      },
      positionIndex: {
        universalIdentifier: 'fa8ae70f-9377-4c5a-8b4e-f242ec86510b',
      },
    },
  },
  recordListMember: {
    universalIdentifier: '1baecd58-aea6-4df4-9e40-2d114b4aedda',
    fields: {
      id: { universalIdentifier: 'c872008c-ba37-42c4-82ec-d77cf2e0617d' },
      createdAt: {
        universalIdentifier: '9b0f12fb-c26f-4139-89ff-1af8086a7242',
      },
      updatedAt: {
        universalIdentifier: '4f508fee-0b65-47d0-ac56-06caa25b13c6',
      },
      deletedAt: {
        universalIdentifier: 'c308a76c-868a-4f6b-9061-6d87ddc0bc32',
      },
      createdBy: {
        universalIdentifier: 'a7c5a803-a3b3-4388-8573-e17440ac1e5b',
      },
      updatedBy: {
        universalIdentifier: '79ff712b-164e-4705-843a-c98476e18c30',
      },
      position: {
        universalIdentifier: '9633939e-e673-4446-a5ea-9399175e0d62',
      },
      searchVector: {
        universalIdentifier: '4c0f5cef-ef1c-43a5-adbe-da01d6b51c7f',
      },
      recordList: {
        universalIdentifier: 'd8ccb7dd-6329-485a-b162-90d6520f40eb',
      },
      targetCompany: {
        universalIdentifier: 'c4435506-5c8a-47e3-b9e8-53cbe94a4016',
      },
      targetPerson: {
        universalIdentifier: 'd571bc9e-ea2c-485f-9d3b-1fbc6d393236',
      },
      targetOpportunity: {
        universalIdentifier: '7bf7e99a-a0d4-4244-8417-b07ce9e2d541',
      },
    },
    morphIds: {
      targetMorphId: { morphId: 'ae204e7c-6840-458e-abb2-fd966803d2c4' },
    },
    indexes: {
      recordListIdIndex: {
        universalIdentifier: '0b085814-f31e-424f-b064-5d420632cca6',
      },
      companyIdIndex: {
        universalIdentifier: '05516bfc-7563-4268-9546-8d36995f2b3a',
      },
      personIdIndex: {
        universalIdentifier: '781b7a1f-0e84-4b76-8b99-40a5867d844e',
      },
      opportunityIdIndex: {
        universalIdentifier: '9e1fbbd9-7d11-48b0-866a-70efdc741316',
      },
      companyListUniqueIndex: {
        universalIdentifier: '77972c09-21e3-49c9-ba1b-38a860f31bce',
      },
      personListUniqueIndex: {
        universalIdentifier: '3a5b57fc-3e37-4036-a5b0-b719fda9bdcc',
      },
      opportunityListUniqueIndex: {
        universalIdentifier: '76fb73dc-a465-4773-bca6-4662ddc58b56',
      },
    },
  },
  ...
  opportunity: {
    ...
    fields: {
      ...
      recordListMemberships: {
        universalIdentifier: '5f238188-cca3-48f0-a6a2-9a044c76fc04',
      },
      searchVector: {
  ...
  person: {
    ...
    fields: {
      ...
      recordListMemberships: {
        universalIdentifier: 'f0c50e75-c18a-43d4-8897-5f5ac66ef9fa',
      },
      emailOptOut: {
        universalIdentifier: 'ab382526-20b3-4756-bb30-465e6a2c6301',
      },
      sequenceEnrollments: {
  ...
  sequence: {
    universalIdentifier: '6df5ed28-0545-4652-95f9-11b1692bf5ce',
    fields: {
      id: { universalIdentifier: 'ac898e25-baa2-481b-8d4e-e234d891eace' },
      createdAt: {
        universalIdentifier: 'd6f11a43-ad0d-4920-9c92-f9ea9cc53b7f',
      },
      updatedAt: {
        universalIdentifier: 'e25b356f-a8e3-45b0-924a-3519c15391a3',
      },
      deletedAt: {
        universalIdentifier: 'abab3287-f179-465d-a181-73ca2f23bd0c',
      },
      createdBy: {
        universalIdentifier: '7c8e72d3-1669-4bba-98cd-a857be5f8b70',
      },
      updatedBy: {
        universalIdentifier: '7931c0bb-79d8-4e51-ac0f-cb8b7cdd23ba',
      },
      position: {
        universalIdentifier: 'e199d055-270e-4f8c-a098-50f6c897b127',
      },
      searchVector: {
        universalIdentifier: '85392759-1a3b-427a-bed3-d9f8257846e0',
      },
      name: { universalIdentifier: '5b913e1f-2507-4e61-bd21-3692cf79d8c9' },
      status: {
        universalIdentifier: '3a120e67-a3a6-4ca4-8631-2318c08cf625',
      },
      senderConnectedAccountId: {
        universalIdentifier: '94a09f59-3a81-417c-a91c-42cf08765fb8',
      },
      settings: {
        universalIdentifier: '902d7c7d-65c1-4170-854c-e5e7b4334823',
      },
      enrolledCount: {
        universalIdentifier: '8528b682-7f12-4008-b5dc-c424abd86129',
      },
      activeCount: {
        universalIdentifier: '658bff5c-6046-4e0f-a546-1249041eff8c',
      },
      completedCount: {
        universalIdentifier: 'ee3128ac-c48f-4eed-807f-8cd2d8118e24',
      },
      repliedCount: {
        universalIdentifier: '92fd5fc1-bc39-4ff0-9fee-12d42039a1ab',
      },
      failedCount: {
        universalIdentifier: 'ed36fce9-90e7-47f9-8794-cbde6c202263',
      },
      steps: {
        universalIdentifier: '5d770cba-a644-4ae5-acd2-2babdfaa11d6',
      },
      enrollments: {
        universalIdentifier: 'a2042f1a-8f8d-428e-8f24-7cb7642430c3',
      },
    },
    indexes: {},
  },
  sequenceStep: {
    universalIdentifier: '031348f6-f0f8-4e99-984d-f811c6765f70',
    fields: {
      id: { universalIdentifier: '382975a3-b384-41c9-a5a7-5aac54fc9617' },
      createdAt: {
        universalIdentifier: 'abb3cec0-8e84-4175-b04d-313f306acc9a',
      },
      updatedAt: {
        universalIdentifier: 'd9a3bfda-8dca-4a9b-be20-c65222457c87',
      },
      deletedAt: {
        universalIdentifier: '69fc043f-3ade-4be6-b9f5-22429296af5c',
      },
      createdBy: {
        universalIdentifier: '2548b262-b8cc-458d-a8d2-dab2851e93b3',
      },
      updatedBy: {
        universalIdentifier: '04f2ef89-6e02-4975-8ed7-de3a294b7f23',
      },
      position: {
        universalIdentifier: '291f2abc-a2df-411b-b7b7-a17eb7da2ce5',
      },
      searchVector: {
        universalIdentifier: 'e5c4f87d-b898-4e04-a24f-84896453f133',
      },
      sequence: {
        universalIdentifier: '5fac6b29-01d1-45f5-afb7-7ebe42f92ba8',
      },
      name: { universalIdentifier: 'b007dac6-0972-4f59-b94d-8760a4526f23' },
      type: { universalIdentifier: '70e549b3-c123-4e28-a263-744d63c4b5f5' },
      settings: {
        universalIdentifier: 'f9236dd1-1cf3-4748-8909-2a00c872f2a6',
      },
    },
    indexes: {
      sequenceIdIndex: {
        universalIdentifier: '86bef202-2762-46d8-aabd-7964b2167feb',
      },
    },
  },
  sequenceEnrollment: {
    universalIdentifier: '807f6559-1850-49f2-a1fa-afed177c7bb5',
    fields: {
      id: { universalIdentifier: '551d822d-f7ec-48bb-a563-e72773c6bb9f' },
      createdAt: {
        universalIdentifier: 'c6aa348f-4d9e-4726-8ec3-3e2516a01023',
      },
      updatedAt: {
        universalIdentifier: 'd0a357b7-f3c9-4e33-aee6-55c513e33704',
      },
      deletedAt: {
        universalIdentifier: '236bec04-afb6-46ec-b305-e5b9b681c89c',
      },
      createdBy: {
        universalIdentifier: '3678a390-bc7b-4757-9ffd-d771716c7c5f',
      },
      updatedBy: {
        universalIdentifier: '9b5777dc-effe-459f-849a-8d9bc7bdfac1',
      },
      position: {
        universalIdentifier: '57993523-98ad-4143-99c9-69b870fd4066',
      },
      searchVector: {
        universalIdentifier: 'e3eeeccd-74ee-4bd1-9469-152ee33daa1d',
      },
      sequence: {
        universalIdentifier: '4f9c2610-b48f-4931-bf35-6b6320811172',
      },
      person: {
        universalIdentifier: '9f950875-e3f1-46ba-9f1f-52c7aab4c2cc',
      },
      status: {
        universalIdentifier: '7f9c8578-0a5c-49f9-93a8-46d0e23ab252',
      },
      currentStepId: {
        universalIdentifier: '1fa81f83-c9f9-422d-a729-7c43d2a9a4f6',
      },
      currentStepPosition: {
        universalIdentifier: '27f7f75b-4dd5-4bbf-bcea-b733a649840b',
      },
      waitingOn: {
        universalIdentifier: 'ebf4f4bd-c1a3-433b-8ab5-a7c3d0ac3d59',
      },
      nextActionAt: {
        universalIdentifier: '597afc27-67b2-45ea-af93-3dddc742f959',
      },
      senderConnectedAccountId: {
        universalIdentifier: '62134b24-3991-4b68-938f-dec8ea92b228',
      },
      stopOnReply: {
        universalIdentifier: '8aa09c9e-572e-4a50-b57c-f9bd71932727',
      },
      startedAt: {
        universalIdentifier: '4b4d094c-57ac-4be6-b3d9-96b128f67ad0',
      },
      endedAt: {
        universalIdentifier: '19e8a1dc-2221-40ca-be1e-f03622daceab',
      },
      errorMessage: {
        universalIdentifier: 'a975a2f2-dff4-4c93-b805-dba35c5bef8c',
      },
      sentEmailsByStepId: {
        universalIdentifier: 'd7df9b8b-5e67-4bc5-a753-11d620872bac',
      },
      lastSendAttempt: {
        universalIdentifier: 'f58d54e6-a6f5-43ff-9b9d-16fa07b1cd88',
      },
    },
    indexes: {
      sequenceIdIndex: {
        universalIdentifier: 'aa99e8b4-d65a-455d-8171-c71357ab030b',
      },
      personIdIndex: {
        universalIdentifier: '5e4626a2-bef5-40cc-9fda-a48b87455599',
      },
      personSequenceUniqueIndex: {
        universalIdentifier: 'd93a35d0-013d-4502-94d0-118cfb3f19fa',
      },
  ...
  task: {
    ...
    fields: {
      ...
      type: { universalIdentifier: '4d7a7f75-076c-4ddf-bb03-d28d6f4efece' },
      priority: {
        universalIdentifier: '93d003d1-e34e-4949-832c-7e8d0f9c2908',
      },
      sequenceEnrollmentId: {
        universalIdentifier: '5a0273ce-7aab-4876-af29-ffe0dd1d7276',
      },
      sequenceStepId: {
        universalIdentifier: '29e6fc08-79e7-4892-9bd2-7c8c439c97b5',
      },
      createdBy: {
    ...
    indexes: {
      ...
      sequenceEnrollmentIdIndex: {
        universalIdentifier: '62991b17-3e11-4738-af31-715fbfa15306',
      },
      searchVectorGinIndex: {
