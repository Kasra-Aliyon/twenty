...
Führen Sie die Anwendung lokal aus, gehen Sie zu [http://localhost:2001/settings/api-webhooks](http://localhost:2001/settings/api-webhooks), und generieren Sie einen API-Schlüssel.
