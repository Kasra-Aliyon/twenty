...
Das Frontend von Twenty läuft unter [http://localhost:2001](http://localhost:2001).
Sie können sich mit dem Standard-Demokonto anmelden: `tim@apple.dev` (Passwort: `tim@apple.dev`)

**Backend**

* Der Server von Twenty wird unter [http://localhost:2000](http://localhost:2000) verfügbar sein.
* Die GraphQL-API kann unter [http://localhost:2000/graphql](http://localhost:2000/graphql) erreicht werden.
* Die REST-API ist erreichbar unter [http://localhost:2000/rest](http://localhost:2000/rest)
