...
Фронтенд Twenty будет работать на [http://localhost:2001](http://localhost:2001).
Вы можете войти, используя учетную запись демо по умолчанию: `tim@apple.dev` (пароль: `tim@apple.dev`)

**Backend**

* Сервер Twenty будет работать на [http://localhost:2000](http://localhost:2000).
* К GraphQL API можно получить доступ по адресу [http://localhost:2000/graphql](http://localhost:2000/graphql).
* К REST API можно обратиться по адресу [http://localhost:2000/rest](http://localhost:2000/rest).
