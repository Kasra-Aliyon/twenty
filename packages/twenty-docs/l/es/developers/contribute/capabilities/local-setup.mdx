...
El frontend de Twenty estará ejecutándose en [http://localhost:2001](http://localhost:2001).
Puede iniciar sesión usando la cuenta demo por defecto: `tim@apple.dev` (contraseña: `tim@apple.dev`)

**Backend**

* El servidor de Twenty estará operativo en [http://localhost:2000](http://localhost:2000)
* La API GraphQL puede ser accedida en [http://localhost:2000/graphql](http://localhost:2000/graphql)
* La API REST puede ser alcanzada en [http://localhost:2000/rest](http://localhost:2000/rest)
