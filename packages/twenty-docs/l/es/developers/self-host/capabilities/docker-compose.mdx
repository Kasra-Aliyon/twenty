...
Si alojas twentyCRM en tu propia computadora, abre tu navegador y navega a [http://localhost:2000](http://localhost:2000).
...
Por defecto, Twenty se ejecuta en `localhost` en el puerto `2000`. Para acceder a él mediante un dominio externo o dirección IP, necesitas configurar `SERVER_URL` en tu archivo `.env`.
