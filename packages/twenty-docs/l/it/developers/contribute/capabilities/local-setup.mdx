...
Il frontend di Twenty sarà in esecuzione su [http://localhost:2001](http://localhost:2001).
Puoi accedere utilizzando l'account demo predefinito: `tim@apple.dev` (password: `tim@apple.dev`)

**Backend**

* Il server di Twenty sarà attivo e funzionante su [http://localhost:2000](http://localhost:2000)
* L'API GraphQL è accessibile su [http://localhost:2000/graphql](http://localhost:2000/graphql)
* L'API REST è raggiungibile su [http://localhost:2000/rest](http://localhost:2000/rest)
