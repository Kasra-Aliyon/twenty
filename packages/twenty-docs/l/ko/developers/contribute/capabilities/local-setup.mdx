...
Twenty의 프론트엔드는 [http://localhost:2001](http://localhost:2001)에서 실행됩니다.
기본 데모 계정을 사용하여 로그인할 수 있습니다: `tim@apple.dev` (비밀번호: `tim@apple.dev`)

**백엔드**

* Twenty의 서버는 [http://localhost:2000](http://localhost:2000)에서 실행됩니다.
* GraphQL API는 [http://localhost:2000/graphql](http://localhost:2000/graphql)에서 액세스할 수 있습니다
* REST API는 [http://localhost:2000/rest](http://localhost:2000/rest)에서 액세스할 수 있습니다
