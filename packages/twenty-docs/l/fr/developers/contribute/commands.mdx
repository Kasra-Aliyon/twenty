...
title: Commandes
icon: terminal
description: Commandes utiles pour développer Twenty.
---
...
```bash
npx nx start twenty-front          # Frontend dev server (http://localhost:2001)
npx nx start twenty-server         # Backend server (http://localhost:2000)
