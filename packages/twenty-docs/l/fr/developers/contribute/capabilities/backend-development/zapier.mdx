...
Exécutez l'application localement, rendez-vous sur [http://localhost:2001/settings/api-webhooks](http://localhost:2001/settings/api-webhooks) et générez une clé API.
