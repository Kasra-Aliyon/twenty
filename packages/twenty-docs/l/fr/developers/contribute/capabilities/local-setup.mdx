...
Le frontend de Twenty sera en cours d'exécution à [http://localhost:2001](http://localhost:2001).
Vous pouvez vous connecter en utilisant le compte démo par défaut : `tim@apple.dev` (mot de passe : `tim@apple.dev`)

**Backend**

* Le serveur de Twenty sera en fonctionnement à [http://localhost:2000](http://localhost:2000)
* L'API GraphQL est accessible à [http://localhost:2000/graphql](http://localhost:2000/graphql)
* L'API REST est joignable à [http://localhost:2000/rest](http://localhost:2000/rest)
