...
Frontend-ul Twenty va rula la [http://localhost:2001](http://localhost:2001).
Vă puteți loga folosind contul demo implicit: `tim@apple.dev` (parolă: `tim@apple.dev`)

**Back-end**

* Serverul Twenty va fi operativ la [http://localhost:2000](http://localhost:2000)
* API-ul GraphQL poate fi accesat la [http://localhost:2000/graphql](http://localhost:2000/graphql)
* API-ul REST poate fi accesat la [http://localhost:2000/rest](http://localhost:2000/rest)
