...
Dacă găzduiți twentyCRM pe propriul computer, deschideți browserul și navigați la [http://localhost:2000](http://localhost:2000).
...
Implicit, Twenty rulează pe `localhost` la portul `2000`. Pentru a-l accesa printr-un domeniu extern sau adresă IP, trebuie să configurați `SERVER_URL` în fișierul dvs. `.env`.
