...
Twenty'nin ön ucu [http://localhost:2001](http://localhost:2001) adresinde çalışıyor olacak.
Varsayılan demo hesabıyla giriş yapabilirsiniz: `tim@apple.dev` (şifre: `tim@apple.dev`)

**Arka Uç**

* Twenty'nin sunucusu [http://localhost:2000](http://localhost:2000) adresinde çalışır durumda olacak
* GraphQL API'sine [http://localhost:2000/graphql](http://localhost:2000/graphql) adresinden erişebilirsiniz.
* REST API'sine [http://localhost:2000/rest](http://localhost:2000/rest) adresinden ulaşabilirsiniz.
