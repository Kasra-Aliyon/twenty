...
Uygulamayı yerel ortamda çalıştırın, [http://localhost:2001/settings/api-webhooks](http://localhost:2001/settings/api-webhooks) adresine gidin ve bir API anahtarı oluşturun.
