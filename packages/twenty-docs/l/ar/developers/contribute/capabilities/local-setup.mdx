...
ستكون واجهة Twenty الأمامية تعمل على  [http://localhost:2001](http://localhost:2001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

* سيكون خادم Twenty متصلاً ويعمل على [http://localhost:2000](http://localhost:2000)
* يمكن الوصول إلى واجهة برمجة التطبيقات GraphQL في [http://localhost:2000/graphql](http://localhost:2000/graphql)
* يمكن الوصول إلى واجهة برمجة التطبيقات REST في [http://localhost:2000/rest](http://localhost:2000/rest)
